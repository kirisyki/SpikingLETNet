...
class SpikingLETNet_shallow_middle(nn.Module):
    def __init__(self, classes=19, config=None):
        ...
        self.downsample_1 = DownSamplingBlock(64, 96)

        self.DAB_Block_1 = nn.Sequential()
        for i in range(0, block_1):
            self.DAB_Block_1.add_module("DAB_Module_1_" + str(i), DABModule(96, d=2))
        self.bn_prelu_2 = BNPReLU(96)

        # DAB Block 2
        dilation_block_2 = [1, 2, 4]
        self.downsample_2 = DownSamplingBlock(96, 96)
        self.DAB_Block_2 = nn.Sequential()
        for i in range(0, block_2):
            self.DAB_Block_2.add_module("DAB_Module_2_" + str(i),
                                        DABModule(96, d=dilation_block_2[i]))
        self.bn_prelu_3 = BNPReLU(96)

        # DAB Block 3
        #dilation_block_3 = [2, 5, 7, 9, 13, 17]
        dilation_block_3 = [1, 2, 4]
        self.downsample_3 = DownSamplingBlock(96, 32)
...
#DECODER
        ...
        self.LC1 = LongConnection(96, 32, 3, bn_acti=True)
        self.LC2 = LongConnection(96, 32, 3, bn_acti=True)
