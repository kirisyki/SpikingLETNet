...
class SpikingLETNet_shallow(nn.Module):
...
if __name__ == '__main__':
    ...
    model = SpikingLETNet_shallow(classes=19, config='/home/lmh/LETNet/Network/configs/SpikingLETNet_shallow/test.yaml').to(device)
