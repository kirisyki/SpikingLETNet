...
def parse_args():
    ...
    parser.add_argument('/home/wyl/projects/LETNet/Network/configs/SpikingLETNet_shallow/1.3M.yaml--use_ohem', action='store_true', default=False, help='OhemCrossEntropy2d Loss for cityscapes dataset')
